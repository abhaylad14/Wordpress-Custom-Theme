  ...
  <footer id="footer" class="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong><span>Abhay Lad</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://bootstrapmade.com/">Abhay Lad</a>
      </div>
    </div>
  </footer><!-- End Footer -->
  ...
  <script>
      let z = document.getElementsByClassName("wp-block-image");
      for(let i=0; i< z.length; i++){
        z[i].children[0].removeAttribute("class");
        z[i].children[0].removeAttribute("height");
        z[i].children[0].removeAttribute("width");
        z[i].children[0].classList.add("container")
    }
  </script>
  <?php wp_footer(); ?>
