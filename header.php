...
<script>
    let x = document.getElementsByClassName("page_item");
    // x.classList.add("mystyle");
    for(let i=0; i< x.length; i++){
        x[i].classList.add("nav-link");
    }
    x = document.getElementsByClassName("menu-item-has-children");
    for(let i=0; i< x.length; i++){
        x[i].classList.add("dropdown");
    }
</script>
